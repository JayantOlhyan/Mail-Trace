  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
        <div>
          <h1 className="text-3xl font-black tracking-wider text-slate-900 dark:text-slate-100 font-mono">
            THREATTRACE AI
          </h1>
          <p className="text-xs text-slate-600 dark:text-slate-400 font-mono tracking-widest mt-1 uppercase">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg pl-9 pr-4 py-2 text-xs text-slate-800 dark:text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500 font-mono transition"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href="/investigations" className="group">
          <div className="p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-900/60 hover:border-indigo-500/60 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-semibold text-slate-600 dark:text-slate-400 uppercase">Threats Detected</span>
              <div className="p-2 rounded-lg bg-indigo-500/10 text-indigo-400 group-hover:scale-110 transition-transform">
                <ShieldAlert className="w-5 h-5" />
              </div>
            </div>
            <p className="text-3xl font-extrabold font-mono text-slate-900 dark:text-slate-100 mt-3">{metrics.threats_detected}</p>
        ...
        <Link href="/cases" className="group">
          <div className="p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-900/60 hover:border-indigo-500/60 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-semibold text-slate-600 dark:text-slate-400 uppercase">Open Cases</span>
              <div className="p-2 rounded-lg bg-amber-500/10 text-amber-400 group-hover:scale-110 transition-transform">
                <Briefcase className="w-5 h-5" />
              </div>
            </div>
            <p className="text-3xl font-extrabold font-mono text-slate-900 dark:text-slate-100 mt-3">{metrics.open_cases}</p>
        ...
        <Link href="/campaigns" className="group">
          <div className="p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-900/60 hover:border-indigo-500/60 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono font-semibold text-slate-600 dark:text-slate-400 uppercase">Campaign Candidates</span>
              <div className="p-2 rounded-lg bg-purple-500/10 text-purple-400 group-hover:scale-110 transition-transform">
                <Layers className="w-5 h-5" />
              </div>
            </div>
            <p className="text-3xl font-extrabold font-mono text-slate-900 dark:text-slate-100 mt-3">{metrics.campaign_candidates}</p>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-xl flex flex-col">
            <div className="p-4 bg-slate-100 dark:bg-slate-900 flex items-center justify-between border-b border-slate-200 dark:border-slate-800">
            ...
            <div className="divide-y divide-slate-800/60 overflow-y-auto max-h-[350px] flex-1">
              {filteredEmails.length === 0 ? (
                ...
                filteredEmails.map((email) => (
                  <div key={email.id} className="p-3.5 hover:bg-slate-200 dark:bg-slate-800/40 transition-colors flex items-center justify-between gap-4 font-mono text-xs">
                    <div className="min-w-0">
                      <p className="font-sans font-semibold text-slate-800 dark:text-slate-200 truncate">{email.subject}</p>
          ...
          <div className="bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-xl flex flex-col">
            <div className="p-4 bg-slate-100 dark:bg-slate-900 flex items-center justify-between border-b border-slate-200 dark:border-slate-800">
              ...
              <span className="text-xs font-mono text-slate-600 dark:text-slate-400">Score &ge; 80</span>
            </div>
            <div className="divide-y divide-slate-800/60 overflow-y-auto max-h-[350px] flex-1">
          ...
          <div className="bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-xl flex flex-col">
            ...
            <div className="p-4 space-y-4 flex-1">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 rounded-lg text-center">
                  <span className="text-[10px] font-mono text-slate-600 dark:text-slate-400 uppercase block">Active Clusters</span>
                  <span className="text-2xl font-bold font-mono text-purple-400 block mt-1">{metrics.infrastructure_clusters}</span>
                </div>
                <div className="p-4 bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 rounded-lg text-center">
                  <span className="text-[10px] font-mono text-slate-600 dark:text-slate-400 uppercase block">Monitored ASNs</span>
                  <span className="text-2xl font-bold font-mono text-slate-800 dark:text-slate-200 block mt-1">42</span>
                </div>
              </div>
              <div className="p-3 bg-indigo-950/20 border border-indigo-900/40 rounded-lg text-xs leading-relaxed text-slate-700 dark:text-slate-300">
            ...
            <div className="divide-y divide-slate-800/60 overflow-y-auto max-h-[350px] flex-1">
              {cases.length === 0 ? (
                ...
                cases.slice(0, 5).map((c) => (
                  <div key={c.id} className="p-3.5 hover:bg-slate-200 dark:bg-slate-800/40 transition-colors flex items-center justify-between gap-4 font-mono text-xs">
                    <div className="min-w-0">
                      <span className="text-[10px] font-bold text-amber-400 bg-amber-950/80 px-1.5 py-0.5 rounded border border-amber-800/60 mr-2">
                        {c.case_id}
                      </span>
                      <span className="font-sans font-bold text-slate-800 dark:text-slate-200 truncate">{c.title}</span>
                    </div>
