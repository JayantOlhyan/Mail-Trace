        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="bg-slate-900 border border-slate-800 rounded-lg pl-9 pr-4 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500 font-mono"
            />
          </div>
              ...
              <tbody className="divide-y divide-slate-800/60 font-mono text-xs text-slate-300">
                {filtered.map((email) => (
                  <tr key={email.id} className="hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="p-3.5 max-w-[200px] truncate text-slate-300">{email.sender}</td>
                    <td className="p-3.5 max-w-xs truncate font-sans text-slate-200 font-medium">
                      {email.subject}
                    </td>
