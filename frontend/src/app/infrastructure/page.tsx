    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {sampleClusters.map((cluster) => (
          <div key={cluster.id} className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-slate-400">Correlation: {cluster.confidence}%</span>
            </div>

            <h3 className="font-bold text-slate-100 text-base">{cluster.name}</h3>

            <div className="grid grid-cols-2 gap-3 pt-2 font-mono text-xs text-slate-300 border-t border-slate-800">
              <div>
